...
const workflow = [
  {
    title: "Capture once",
    body: "Speak naturally. The raw signal stays attached.",
    icon: CaptureIcon,
  },
  {
    title: "Shape the artifact",
    body: "Turn a transcript into a usable artifact.",
    icon: SparkIcon,
  },
  {
    title: "Pull in context",
    body: "Pull in teammates, folders, and related work.",
    icon: LinkNodesIcon,
  },
];
    ...
    <main className="relative overflow-hidden pb-20">
      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-20 pt-10 sm:pt-16 lg:pb-24 lg:pt-20">
        <div className="grid gap-14 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-800 shadow-[0_8px_20px_-18px_rgba(4,12,27,0.14)]">
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-slate-700 sm:text-lg">
              Capture once. Shape it fast. Keep the work connected.
            </p>

            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href={primaryHref}
                className="inline-flex items-center gap-2 rounded-2xl border border-slate-950 bg-slate-950 px-5 py-3 text-sm font-medium text-white shadow-[0_18px_40px_-24px_rgba(4,12,27,0.4)] transition hover:bg-slate-900"
              >
                {primaryLabel}
              ...
              <a
                href="#product"
                className="inline-flex items-center gap-2 rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-medium text-slate-950 shadow-[0_10px_28px_-20px_rgba(4,12,27,0.2)] transition hover:border-slate-400 hover:bg-slate-50"
              >
                See the flow
              </a>
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              {suite.map((item) => (
                <span
                  key={item}
                  className="rounded-full border border-slate-300 bg-white px-3 py-1.5 text-xs font-medium text-slate-800 shadow-[0_8px_20px_-18px_rgba(4,12,27,0.14)]"
                >
                  {item}
                </span>
              ))}
      ...
      <section id="product" className="relative mx-auto max-w-7xl px-6 py-8 lg:py-10">
        <SectionHeader
          eyebrow="Product"
          title="From rough input to shared execution"
          body="A quieter workflow for capture, collaboration, and retrieval."
        />
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
              <div>
                ...
                <p className="mt-3 text-sm leading-7 text-slate-600">
                  Record naturally, then move straight into structure.
                </p>
              ...
              <div className="rounded-[28px] border border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(243,247,255,0.92))] p-4 shadow-[0_22px_60px_-42px_rgba(15,23,42,0.18)]">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <div className="mt-1 text-xs text-slate-600">Live transcript shaping into a PRD</div>
                  </div>
                ...
                <div className="mt-4 rounded-[22px] border border-slate-300/80 bg-white/96 p-4">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">Transcript</div>
                ...
                <div className="mt-4 rounded-[22px] border border-slate-300/80 bg-white/96 p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">Structured doc</div>
                    <span className="rounded-full border border-slate-200/80 bg-[rgb(var(--accent-soft)_/_0.82)] px-2 py-1 text-[11px] font-medium text-slate-800">
                      Decision ready
                    </span>
                  </div>
          ...
          <div className="grid gap-5">
            <MarketingCard className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                Review in context and keep momentum.
              </p>
            ...
            <MarketingCard className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                Search, folders, and clusters stay in sync.
              </p>
        ...
        <div className="grid gap-5 lg:grid-cols-[0.94fr_1.06fr]">
          ...
          <MarketingCard className="p-5 lg:p-6">
            <div className="grid gap-4 lg:grid-cols-[0.92fr_1.08fr]">
              <div className="rounded-[28px] border border-slate-200/90 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(244,246,255,0.95))] p-4 shadow-[0_20px_60px_-42px_rgba(15,23,42,0.16)]">
                <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">Team surface</div>
              ...
              <div className="rounded-[30px] border border-slate-200/80 bg-white/96 p-5 shadow-[0_22px_70px_-44px_rgba(15,23,42,0.18)]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-xs text-slate-600">Research and synthesis</div>
                  </div>
                </div>
                ...
                <div className="mt-4 rounded-[22px] border border-slate-200 bg-white p-4">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">Usually found in</div>
                  <div className="mt-3 grid gap-2">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.04fr_0.96fr]">
          <MarketingCard className="p-6 lg:p-7">
            ...
            <p className="mt-4 max-w-xl text-sm leading-7 text-slate-700">
              Aceync infers links from structure and transcription language, so related work surfaces even when nobody manually filed it.
            </p>
            <div className="mt-6 grid gap-3">
              <NetworkFact
          ...
          <MarketingCard className="p-5 lg:p-6">
            <div className="rounded-[30px] border border-slate-200/90 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(241,246,255,0.94))] p-4 shadow-[0_22px_70px_-44px_rgba(15,23,42,0.18)]">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <div className="text-sm font-semibold text-slate-900">Workspace network</div>
                  <div className="mt-1 text-xs text-slate-600">Hover to trace. Click to go deeper.</div>
                </div>
                <span className="rounded-full border border-slate-200 bg-white px-2.5 py-1 text-[11px] font-medium text-slate-600">
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-10">
        <div className="grid gap-4 rounded-[34px] border border-slate-200/90 bg-[linear-gradient(135deg,rgba(225,236,255,0.9),rgba(245,240,255,0.92),rgba(255,255,255,0.98))] p-6 shadow-[0_30px_90px_-48px_rgba(15,23,42,0.2)] lg:grid-cols-[0.85fr_1.15fr] lg:p-8">
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">Why teams switch</div>
            <h3 className="mt-3 text-3xl font-semibold tracking-[-0.05em] text-slate-950">
              One place for the work after the update lands.
            </h3>
          </div>
      ...
      <section id="footer-cta" className="relative mx-auto max-w-7xl px-6 pb-12 pt-8">
        <div className="overflow-hidden rounded-[36px] border border-slate-200/80 bg-slate-950 px-6 py-8 text-white shadow-[0_40px_120px_-64px_rgba(15,23,42,0.7)] lg:px-8 lg:py-10">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-white/60">Aceync</div>
              <h2 className="mt-3 max-w-3xl text-4xl font-semibold tracking-[-0.05em] text-white">
                Turn spoken thinking into shared execution.
              </h2>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-white/72">
                Capture faster. Keep the work legible.
              </p>
            </div>
...
function HeroCanvas() {
  return (
    <div className="glass-strong relative overflow-hidden rounded-[36px] p-5 shadow-[0_36px_110px_-58px_rgba(4,12,27,0.18)]">
      ...
      <div className="relative">
        <div className="glass flex items-center justify-between gap-3 rounded-[24px] border border-slate-300 bg-white/86 px-4 py-3 shadow-[0_10px_24px_-18px_rgba(4,12,27,0.14)]">
          <div className="flex items-center gap-3">
            <LoopMark className="h-8 w-8 text-slate-950" />
            <div>
              <div className="text-sm font-semibold text-slate-900">Aceync workspace</div>
              <div className="mt-1 text-xs text-slate-600">Capture · Collaborate · Connect</div>
            </div>
          </div>
            ...
            <PreviewCard className="p-4">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <div className="mt-1 text-xs text-slate-600">Transcript appears instantly</div>
                </div>
          ...
          <div className="grid gap-4">
            <PreviewCard className="p-5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <div className="mt-1 text-xs text-slate-600">A voice note becomes structured work</div>
                </div>
                <span className="rounded-full border border-slate-300 bg-white px-2.5 py-1 text-[11px] font-medium text-slate-800">
                  Draft
                </span>
              </div>
              ...
              <div className="mt-4 rounded-[22px] border border-slate-300 bg-white p-4 shadow-[0_12px_28px_-24px_rgba(4,12,27,0.12)]">
                <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">Suggestions</div>
                <div className="mt-3 flex items-center gap-3 rounded-2xl border border-slate-300 bg-white px-3 py-3 shadow-[0_10px_24px_-20px_rgba(4,12,27,0.1)]">
                  <div className="min-w-0 flex-1">
                    <div className="truncate text-sm font-medium text-slate-900">Replace “Slack only” with broader tool integration</div>
                    <div className="mt-1 text-xs text-slate-600">Suggested by Marcus · stays in context</div>
                  </div>
            ...
            <div className="grid gap-4 sm:grid-cols-[1.05fr_0.95fr]">
              <PreviewCard className="p-4">
                ...
                <div className="mt-3 h-28 rounded-[20px] border border-slate-300 bg-[radial-gradient(circle_at_18%_20%,rgba(231,243,255,0.86),transparent_34%),radial-gradient(circle_at_82%_18%,rgba(243,238,255,0.72),transparent_32%),rgba(255,255,255,0.98)] p-3">
                  <div className="relative h-full">
                    <span className="absolute left-2 top-8 rounded-full border border-slate-300 bg-white px-2 py-1 text-[11px] text-slate-800">
                      Artifact
                    </span>
                    <span className="absolute left-[42%] top-3 rounded-full border border-slate-300 bg-white px-2 py-1 text-[11px] text-slate-800">
                      Folder
                    </span>
                    <span className="absolute right-2 bottom-4 rounded-full border border-slate-300 bg-white px-2 py-1 text-[11px] text-slate-800">
                      Suggested cluster
                    </span>
...
function SectionHeader(props: { eyebrow: string; title: string; body: string }) {
  return (
    <div className="max-w-3xl">
      <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">{props.eyebrow}</div>
      <h2 className="mt-3 text-4xl font-semibold tracking-[-0.05em] text-slate-950">{props.title}</h2>
      <p className="mt-4 text-sm leading-7 text-slate-700">{props.body}</p>
    </div>
  );
}
...
function MarketingCard(props: { children: ReactNode; className?: string }) {
  return (
    <div
      className={[
        "glass rounded-[32px] border border-slate-300 bg-white/88 shadow-[0_24px_80px_-52px_rgba(4,12,27,0.14)]",
        props.className ?? "",
      ].join(" ")}
    >
      {props.children}
...
function MetricCard(props: { label: string; value: string }) {
  return (
    <div className="glass rounded-[24px] border border-slate-300 bg-white/88 p-4 shadow-[0_18px_46px_-34px_rgba(4,12,27,0.14)]">
      <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">{props.label}</div>
...
function FeatureLabel(props: { icon: ReactNode; children: ReactNode }) {
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-700 shadow-[0_8px_22px_-18px_rgba(4,12,27,0.16)]">
      {props.icon}
      {props.children}
    </div>
  );
...
function WorkflowRow(props: { icon: ReactNode; title: string; body: string }) {
  return (
    <div className="rounded-[22px] border border-slate-300 bg-white p-4 shadow-[0_14px_30px_-24px_rgba(4,12,27,0.12)]">
      <div className="flex items-center gap-2 text-sm font-semibold text-slate-900">
        <span className="inline-flex h-8 w-8 items-center justify-center rounded-xl border border-slate-200 bg-[linear-gradient(135deg,rgba(231,243,255,0.96),rgba(244,239,255,0.96),rgba(255,241,248,0.94))] text-slate-800">
          {props.icon}
        </span>
        {props.title}
      </div>
      <div className="mt-2 text-sm leading-6 text-slate-700">{props.body}</div>
    </div>
  );
}
...
function PreviewCard(props: { children: ReactNode; className?: string }) {
  return (
    <div
      className={[
        "glass rounded-[28px] border border-slate-300 bg-white/88 shadow-[0_18px_50px_-36px_rgba(4,12,27,0.14)]",
        props.className ?? "",
      ].join(" ")}
    >
      {props.children}
...
function PreviewLine(props: { width: string }) {
  return (
    <div
      className={`h-3 rounded-full bg-[linear-gradient(90deg,rgba(231,243,255,0.98),rgba(243,236,255,0.95),rgba(255,240,246,0.9))] ${props.width}`}
    />
  );
}
...
function MiniPanel(props: { title: string; tone: "blue" | "sky" | "violet" | "pink" }) {
  const tones = {
    blue: "bg-[linear-gradient(135deg,rgba(231,243,255,0.98),rgba(255,255,255,0.98))] border-[rgba(173,217,255,0.92)]",
    sky: "bg-[linear-gradient(135deg,rgba(235,250,255,0.98),rgba(255,255,255,0.98))] border-[rgba(186,230,253,0.86)]",
    violet: "bg-[linear-gradient(135deg,rgba(243,238,255,0.98),rgba(255,255,255,0.98))] border-[rgba(217,203,255,0.92)]",
    pink: "bg-[linear-gradient(135deg,rgba(255,239,246,0.98),rgba(255,255,255,0.98))] border-[rgba(255,209,226,0.92)]",
  } as const;
...
function InlineSuggestionPreview() {
  return (
    <div className="rounded-[22px] border border-slate-300 bg-white p-4 shadow-[0_14px_30px_-24px_rgba(4,12,27,0.12)]">
      <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">Suggestion mode</div>
      <div className="mt-3 grid gap-2">
        ...
        <div className="rounded-2xl border border-slate-300/70 bg-slate-50/92 px-3 py-3 text-sm text-slate-800">
          Reframe it around the artifact: teams capture once, then Aceync structures the work and keeps feedback visible.
        </div>
      </div>
    </div>
  );
...
function CommentThreadPreview() {
  return (
    <div className="rounded-[22px] border border-slate-300 bg-white p-4 shadow-[0_14px_30px_-24px_rgba(4,12,27,0.12)]">
      <div className="flex items-center justify-between gap-3">
        <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600">Async thread</div>
        <span className="rounded-full border border-slate-300 bg-white px-2 py-1 text-[11px] text-slate-800">2 open</span>
      </div>
      <div className="mt-3 grid gap-2">
...
function FolderPreviewCard(props: { title: string; subtitle: string; tone: "blue" | "violet" | "pink" | "sky" }) {
  const tones = {
    ...
    violet: "bg-[linear-gradient(135deg,rgba(243,238,255,0.98),rgba(255,255,255,0.98))] border-[rgba(217,203,255,0.92)]",
    pink: "bg-[linear-gradient(135deg,rgba(255,239,246,0.98),rgba(255,255,255,0.98))] border-[rgba(255,209,226,0.92)]",
    sky: "bg-[linear-gradient(135deg,rgba(235,250,255,0.98),rgba(255,255,255,0.98))] border-[rgba(186,230,253,0.9)]",
  } as const;

  return (
    <div className={`rounded-[22px] border p-4 ${tones[props.tone]}`}>
      <div className="flex items-center gap-3">
        <span className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-slate-300 bg-white text-slate-800 shadow-[0_8px_20px_-18px_rgba(4,12,27,0.18)]">
          <FolderIcon className="h-4 w-4" />
        </span>
        <div className="min-w-0">
          <div className="truncate text-sm font-semibold text-slate-900">{props.title}</div>
          <div className="truncate text-xs text-slate-600">{props.subtitle}</div>
        </div>
      </div>
    </div>
  );
...
function TeammateRow(props: { name: string; role: string; tone: "blue" | "violet" | "pink" }) {
  const tones = {
    blue: "bg-[linear-gradient(135deg,rgba(231,243,255,0.98),rgba(255,255,255,0.98))]",
    violet: "bg-[linear-gradient(135deg,rgba(243,238,255,0.98),rgba(255,255,255,0.98))]",
    pink: "bg-[linear-gradient(135deg,rgba(255,239,246,0.98),rgba(255,255,255,0.98))]",
  } as const;

  return (
    <div className={`flex items-center justify-between gap-3 rounded-[20px] border border-slate-300 p-3 shadow-[0_10px_24px_-20px_rgba(4,12,27,0.12)] ${tones[props.tone]}`}>
      <div className="min-w-0">
        <div className="truncate text-sm font-medium text-slate-900">{props.name}</div>
        <div className="truncate text-xs text-slate-600">{props.role}</div>
      </div>
      <span className="rounded-full border border-slate-300 bg-white px-2 py-1 text-[11px] uppercase tracking-[0.16em] text-slate-800">
        Open
      </span>
    </div>
  );
...
function MiniTag(props: { children: ReactNode }) {
  return (
    <span className="rounded-full border border-slate-300 bg-white px-3 py-1.5 text-xs font-medium text-slate-800 shadow-[0_8px_20px_-18px_rgba(4,12,27,0.14)]">
      {props.children}
    </span>
  );
}
...
function PreviewListItem(props: { icon: ReactNode; label: string }) {
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-[0_10px_24px_-20px_rgba(4,12,27,0.1)]">
      <span className="inline-flex h-8 w-8 items-center justify-center rounded-xl border border-slate-200 bg-[linear-gradient(135deg,rgba(231,243,255,0.96),rgba(244,239,255,0.94))] text-slate-700">
        {props.icon}
      </span>
...
function ReasonCard(props: { icon: ReactNode; title: string; body: string }) {
  return (
    <div className="rounded-[24px] border border-slate-300 bg-white p-4 shadow-[0_14px_34px_-26px_rgba(4,12,27,0.12)]">
      <div className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-[linear-gradient(135deg,rgba(231,243,255,0.96),rgba(244,239,255,0.94),rgba(255,241,248,0.92))] text-slate-700">
        {props.icon}
      </div>
...
function HeaderPill(props: { icon: ReactNode; label: string }) {
  return (
    <span className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-3 py-1.5 text-[11px] font-medium text-slate-800 shadow-[0_8px_20px_-18px_rgba(4,12,27,0.14)]">
      {props.icon}
      {props.label}
    </span>
  );
...
function GraphNode(props: { x: string; y: string; label: string; tone: "root" | "blue" | "sky" | "violet" | "pink" | "muted" }) {
  const tones = {
    root: "bg-[linear-gradient(135deg,rgba(231,243,255,1),rgba(255,255,255,0.98))] border-[rgba(173,217,255,0.95)]",
    blue: "bg-[linear-gradient(135deg,rgba(231,243,255,0.98),rgba(255,255,255,0.98))] border-[rgba(173,217,255,0.92)]",
    sky: "bg-[linear-gradient(135deg,rgba(235,250,255,0.98),rgba(255,255,255,0.98))] border-[rgba(186,230,253,0.9)]",
    violet: "bg-[linear-gradient(135deg,rgba(243,238,255,0.98),rgba(255,255,255,0.98))] border-[rgba(217,203,255,0.92)]",
    pink: "bg-[linear-gradient(135deg,rgba(255,239,246,0.98),rgba(255,255,255,0.98))] border-[rgba(255,209,226,0.92)]",
    muted: "bg-white border-slate-300",
  } as const;

  return (
    <div
      className={`absolute -translate-x-1/2 -translate-y-1/2 rounded-full border px-3 py-2 text-xs font-medium text-slate-800 shadow-[0_14px_32px_-24px_rgba(4,12,27,0.14)] ${tones[props.tone]}`}
